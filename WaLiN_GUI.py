...
class WaLiN_GUI_Window(QMainWindow):
...
def main():
    ...
    WaLiN_GUI = QApplication([])
    walinGUIwindow = WaLiN_GUI_Window()
    walinGUIwindow.show()

    sys.exit(WaLiN_GUI.exec())  # TODO inlcude removing tmp folder
